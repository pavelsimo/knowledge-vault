...
- [[raw/reference-packs/system-design/System Design.md|raw/reference-packs/system-design/System Design.md]]
- [[raw/reference-packs/system-design/diagrams/README.md|raw/reference-packs/system-design/diagrams/README.md]]
...
- [[raw/reference-packs/system-design/diagrams/README.md|raw/reference-packs/system-design/diagrams/README.md]] - explains that the local `.excalidraw` files are intended to be imported into Excalidraw for viewing, editing, or export.
- [[raw/reference-packs/system-design/diagrams/api-gateway.excalidraw|raw/reference-packs/system-design/diagrams/api-gateway.excalidraw]] - gateway as the front door for routing, auth, and request aggregation.
- [[raw/reference-packs/system-design/diagrams/caching.excalidraw|raw/reference-packs/system-design/diagrams/caching.excalidraw]] - cache placement and read/write policy tradeoffs.
- [[raw/reference-packs/system-design/diagrams/cap.excalidraw|raw/reference-packs/system-design/diagrams/cap.excalidraw]] - visual summary of consistency, availability, and partition tolerance under failure.
- [[raw/reference-packs/system-design/diagrams/cdn.excalidraw|raw/reference-packs/system-design/diagrams/cdn.excalidraw]] - origin plus edge-distribution topology for global latency reduction.
- [[raw/reference-packs/system-design/diagrams/circuit-breaker.excalidraw|raw/reference-packs/system-design/diagrams/circuit-breaker.excalidraw]] - failure isolation pattern that trips open when a dependency degrades.
- [[raw/reference-packs/system-design/diagrams/clustering.excalidraw|raw/reference-packs/system-design/diagrams/clustering.excalidraw]] - active-active and active-passive node grouping for HA.
- [[raw/reference-packs/system-design/diagrams/consistent-hashing.excalidraw|raw/reference-packs/system-design/diagrams/consistent-hashing.excalidraw]] - hash-ring layout that minimizes key movement during resharding.
- [[raw/reference-packs/system-design/diagrams/cqrs.excalidraw|raw/reference-packs/system-design/diagrams/cqrs.excalidraw]] - separate command and query paths for differing read/write workloads.
- [[raw/reference-packs/system-design/diagrams/database-replication.excalidraw|raw/reference-packs/system-design/diagrams/database-replication.excalidraw]] - master-replica and replication-flow topology.
- [[raw/reference-packs/system-design/diagrams/db-dbms.excalidraw|raw/reference-packs/system-design/diagrams/db-dbms.excalidraw]] - distinction between a database and the database-management system around it.
- [[raw/reference-packs/system-design/diagrams/disaster-recovery.excalidraw|raw/reference-packs/system-design/diagrams/disaster-recovery.excalidraw]] - backup, failover, and recovery-region planning.
- [[raw/reference-packs/system-design/diagrams/distributed-transactions.excalidraw|raw/reference-packs/system-design/diagrams/distributed-transactions.excalidraw]] - coordinator-driven commit flow across multiple nodes.
- [[raw/reference-packs/system-design/diagrams/domain-name-system.excalidraw|raw/reference-packs/system-design/diagrams/domain-name-system.excalidraw]] - recursive and iterative DNS resolution path.
- [[raw/reference-packs/system-design/diagrams/enterprise-service-bus.excalidraw|raw/reference-packs/system-design/diagrams/enterprise-service-bus.excalidraw]] - centrally mediated enterprise integration pattern.
- [[raw/reference-packs/system-design/diagrams/event-driven-architecture.excalidraw|raw/reference-packs/system-design/diagrams/event-driven-architecture.excalidraw]] - producers, events, and asynchronous consumers.
- [[raw/reference-packs/system-design/diagrams/event-sourcing.excalidraw|raw/reference-packs/system-design/diagrams/event-sourcing.excalidraw]] - append-only event log as the source of truth.
- [[raw/reference-packs/system-design/diagrams/federated-database.excalidraw|raw/reference-packs/system-design/diagrams/federated-database.excalidraw]] - unified access across independently owned databases.
- [[raw/reference-packs/system-design/diagrams/geohashing-quadtrees.excalidraw|raw/reference-packs/system-design/diagrams/geohashing-quadtrees.excalidraw]] - spatial indexing approaches for location-aware systems.
- [[raw/reference-packs/system-design/diagrams/indexes.excalidraw|raw/reference-packs/system-design/diagrams/indexes.excalidraw]] - index data structures and lookup acceleration.
- [[raw/reference-packs/system-design/diagrams/load-balancing.excalidraw|raw/reference-packs/system-design/diagrams/load-balancing.excalidraw]] - request distribution across backend servers.
- [[raw/reference-packs/system-design/diagrams/lp-ws-sse.excalidraw|raw/reference-packs/system-design/diagrams/lp-ws-sse.excalidraw]] - long polling, WebSockets, and server-sent events compared for realtime delivery.
- [[raw/reference-packs/system-design/diagrams/message-brokers.excalidraw|raw/reference-packs/system-design/diagrams/message-brokers.excalidraw]] - brokered messaging with routing and decoupled producers/consumers.
- [[raw/reference-packs/system-design/diagrams/message-queues.excalidraw|raw/reference-packs/system-design/diagrams/message-queues.excalidraw]] - queued work distribution and asynchronous processing.
- [[raw/reference-packs/system-design/diagrams/monoliths-microservices.excalidraw|raw/reference-packs/system-design/diagrams/monoliths-microservices.excalidraw]] - service-boundary tradeoffs between one deployment and many.
- [[raw/reference-packs/system-design/diagrams/n-tier-architecture.excalidraw|raw/reference-packs/system-design/diagrams/n-tier-architecture.excalidraw]] - presentation, application, and data-tier separation.
- [[raw/reference-packs/system-design/diagrams/netflix.excalidraw|raw/reference-packs/system-design/diagrams/netflix.excalidraw]] - streaming-system case-study architecture.
- [[raw/reference-packs/system-design/diagrams/oauth-openid-connect.excalidraw|raw/reference-packs/system-design/diagrams/oauth-openid-connect.excalidraw]] - delegated authorization plus identity-layer flow.
- [[raw/reference-packs/system-design/diagrams/osi.excalidraw|raw/reference-packs/system-design/diagrams/osi.excalidraw]] - seven-layer networking stack.
- [[raw/reference-packs/system-design/diagrams/pacelc.excalidraw|raw/reference-packs/system-design/diagrams/pacelc.excalidraw]] - latency-versus-consistency tradeoff outside partition events.
- [[raw/reference-packs/system-design/diagrams/proxy.excalidraw|raw/reference-packs/system-design/diagrams/proxy.excalidraw]] - forward and reverse proxy placement.
- [[raw/reference-packs/system-design/diagrams/pubsub.excalidraw|raw/reference-packs/system-design/diagrams/pubsub.excalidraw]] - topic-based publish/subscribe fan-out.
- [[raw/reference-packs/system-design/diagrams/rate-limiting.excalidraw|raw/reference-packs/system-design/diagrams/rate-limiting.excalidraw]] - throttling patterns for protecting shared services.
- [[raw/reference-packs/system-design/diagrams/scaling.excalidraw|raw/reference-packs/system-design/diagrams/scaling.excalidraw]] - scale-up versus scale-out resource growth.
- [[raw/reference-packs/system-design/diagrams/service-discovery.excalidraw|raw/reference-packs/system-design/diagrams/service-discovery.excalidraw]] - dynamic lookup of service instances in distributed systems.
- [[raw/reference-packs/system-design/diagrams/sharding.excalidraw|raw/reference-packs/system-design/diagrams/sharding.excalidraw]] - horizontal partitioning of data across nodes.
- [[raw/reference-packs/system-design/diagrams/sso.excalidraw|raw/reference-packs/system-design/diagrams/sso.excalidraw]] - single-sign-on flow across multiple applications.
- [[raw/reference-packs/system-design/diagrams/tcp-udp.excalidraw|raw/reference-packs/system-design/diagrams/tcp-udp.excalidraw]] - transport-layer tradeoff between reliability and latency.
- [[raw/reference-packs/system-design/diagrams/transactions.excalidraw|raw/reference-packs/system-design/diagrams/transactions.excalidraw]] - atomic database transaction lifecycle.
- [[raw/reference-packs/system-design/diagrams/twitter.excalidraw|raw/reference-packs/system-design/diagrams/twitter.excalidraw]] - social-feed case-study architecture.
- [[raw/reference-packs/system-design/diagrams/uber.excalidraw|raw/reference-packs/system-design/diagrams/uber.excalidraw]] - ride-matching and geospatial case-study architecture.
- [[raw/reference-packs/system-design/diagrams/url-shortener.excalidraw|raw/reference-packs/system-design/diagrams/url-shortener.excalidraw]] - classic short-link service decomposition.
- [[raw/reference-packs/system-design/diagrams/virtualization-containerization.excalidraw|raw/reference-packs/system-design/diagrams/virtualization-containerization.excalidraw]] - virtualization stack compared with containers.
- [[raw/reference-packs/system-design/diagrams/whatsapp.excalidraw|raw/reference-packs/system-design/diagrams/whatsapp.excalidraw]] - messaging-system case-study architecture.
