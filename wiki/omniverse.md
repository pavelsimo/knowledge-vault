...
- [[raw/reference-packs/omniverse/.gitignore|raw/reference-packs/omniverse/.gitignore]] - ignores local JetBrains project metadata so tutorial workspaces stay clean.
- [[raw/reference-packs/omniverse/requirements.txt|raw/reference-packs/omniverse/requirements.txt]] - pins the minimal Python stack for notebook demos: `usd-core`, packaging helpers, `requests`, and IPython.
- [[raw/reference-packs/omniverse/utils/__init__.py|raw/reference-packs/omniverse/utils/__init__.py]] - re-exports helper modules while intentionally excluding visualization imports that may require vendor packages too early.
- [[raw/reference-packs/omniverse/utils/health_checks.py|raw/reference-packs/omniverse/utils/health_checks.py]] - validates Python-package compatibility against `requirements.txt` before notebook visualization is attempted.
- [[raw/reference-packs/omniverse/utils/helperfunctions.py|raw/reference-packs/omniverse/utils/helperfunctions.py]] - provides `create_new_stage`, a safe helper that reuses an existing USD layer or creates a new one.
- [[raw/reference-packs/omniverse/utils/sample_assets.py|raw/reference-packs/omniverse/utils/sample_assets.py]] - generates or downloads sample USD content, including large demonstration assets for visualization workflows.
- [[raw/reference-packs/omniverse/utils/setup.py|raw/reference-packs/omniverse/utils/setup.py]] - centralizes content-directory paths used by the notebook tooling.
- [[raw/reference-packs/omniverse/utils/visualization.py|raw/reference-packs/omniverse/utils/visualization.py]] - serves USD files and renders syntax-highlighted or interactive HTML viewers inside Jupyter.
...
![Omniverse brings multiple industrial tools and stakeholders into one shared virtual factory workflow.](../raw/reference-packs/omniverse/images/03-virtual-factory-integration.png)
...
![A factory digital twin is typically assembled as layered USD assets with shared materials, lighting, and payloads.](../raw/reference-packs/omniverse/images/04-factory-assembly-graph.png)
