...
![The `transformers` pipeline wraps preprocessing, model execution, and postprocessing behind one task-level interface.](../raw/course-material/open-source-models-hugging-face/images/img.png)
