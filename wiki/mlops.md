...
- [[raw/course-material/machine-learning-engineering-for-production-mlops/Machine Learning Engineering for Production (MLOps).md|raw/course-material/machine-learning-engineering-for-production-mlops/Machine Learning Engineering for Production (MLOps).md]]
...
![MLOps distinguishes changing inputs from changing input-to-label meaning.](../raw/course-material/machine-learning-engineering-for-production-mlops/images/Pasted%20image%2020260227112907.png)
...
![Deployment monitoring is iterative in the same way model development is iterative: traffic, performance, and analysis feed continuous adjustment.](../raw/course-material/machine-learning-engineering-for-production-mlops/images/Pasted%20image%2020260227121101.png)
...
![Blue-green deployment keeps old and new production stacks live behind a router.](../raw/course-material/machine-learning-engineering-for-production-mlops/images/Pasted%20image%2020260227115016.png)
...
![A confusion matrix makes precision and recall concrete by showing exactly where false positives and false negatives come from.](../raw/course-material/machine-learning-engineering-for-production-mlops/images/Pasted%20image%2020260228152616.png)
