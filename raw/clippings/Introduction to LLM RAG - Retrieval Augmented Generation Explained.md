...
![[raw/00-clippings/images/e83dac9a1b53f65fbcd1c93ecee3054a_MD5.png]]
...
![[raw/00-clippings/images/65286482e371a2547193d6cc7c4c0ddf_MD5.png]]
...
![[raw/00-clippings/images/51652fa1ddb789a86bf62a867a9b5a1e_MD5.png]]
...
In production RAG pipelines, retrieval quality is heavily influenced by [**chunking strategy**](https://weaviate.io/blog/chunking-strategies-for-rag) and how you index content for search and filtering.
...
<video width="100%" controls=""><source src="https://weaviate.io/assets/medias/verba_nocompress-c9ffbda2b6874ab2dae69bb837ed963d.mp4" type="video/mp4"><p>Your browser does not support the video tag.</p></video>
...
![[raw/00-clippings/images/68e09fa6be5963c41860ad3813eaff80_MD5.png]]
...
**AI agents** are autonomous systems that can interpret information, formulate plans, and make decisions. When added to a RAG pipeline, agents can reformulate user queries and re-retrieve more relevant information if initial results are inaccurate or irrelevant. [**Agentic RAG**](https://weaviate.io/blog/what-is-agentic-rag) can also handle more complex queries that require multi-step reasoning, like comparing information across multiple documents, asking follow-up questions, and iteratively adjusting retrieval and generation strategies. Agentic RAG extends the LLM RAG pipeline by adding agents that can plan, re-retrieve, validate context, and use tools.
...
![[raw/00-clippings/images/b57fd33701900f9cc54de9b15a87464e_MD5.png]]
